...
public class ASCIIArtGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println();
        artGen.printTextArt(FIRST_WORD, ASCIIArtGenerator.ART_SIZE_FIRST_WORD);
        System.out.println();
         
        System.out.println();
        artGen.printTextArt(SECOND_WORD, ASCIIArtGenerator.ART_SIZE_SECOND_WORD, FONT, SECOND_WORD_CHAR);
        System.out.println();
    }
